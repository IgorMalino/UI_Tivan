...
const Web3ReactConnectionComponent = () => {
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={checkInfoSimple}>Check web3react Context</button>
        <button onClick={disconnectMetamaskSimple}>Disconnect Web3React</button>
      </div>
      <div>
      ...
      <div>
        <button onClick={connectBinanceWallet}>
