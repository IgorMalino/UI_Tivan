    ...
    return (
        ...
        <div id="language">
            ...
            >
              ...
              <ReactCountryFlag style={{fontSize: "17px"}} countryCode={i18n.language === "en" ? "US" : "RU"} />
            </a>
            <ThemeProvider  theme={theme}>
              ...
              >
                ...
                <li onClick={(e) => onChange(e)} className="icocu"><a data="en"  ><ReactCountryFlag data="en" countryCode="US" />ENG</a></li>
                <li onClick={(e) => onChange(e)} className="icocu"><a data="ru" ><ReactCountryFlag data="ru" countryCode="RU" />RUS</a></li>
