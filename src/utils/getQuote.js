...
export const getQuote = () => {
    const e = [
        ...
        ["231", "Two things are infinite: the universe and human stupidity; and I’m not sure about the universe."],
        ["240", "If you want to be somebody, somebody really special, be yourself!"],
        ["289", "Advice is like snow; the softer it falls the longer it dwells upon, and the deeper it sinks into the mind."],
        ["07", "One who looks for a friend without faults will have none."],
        ["25", "All would live long, but none would be old."],
        ["221", "Formal education will make you a living. Self-education will make you a fortune."],
